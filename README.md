...
| **Gestión de Cuentas de Usuario / US051**      | Cambiar idioma                             | Como usuario, quiero cambiar el idioma para poder ver el contenido en mi idioma preferido.                                                     | **Escenario:** Dado que el usuario selecciona un idioma disponible, cuando cambia el idioma, entonces el sistema debería actualizar la interfaz al idioma seleccionado. <br> **Escenario:** Dado que el usuario selecciona un idioma no disponible, cuando cambia el idioma, entonces el sistema no debería cambiar el idioma y permanecer en el idioma actual. |           EP01                |
| **Gestión de Cuentas de Usuario / US052**      | Ver página “No encontrada”                             | Como usuario, quiero ver un mensaje de “Página no encontrada” cuando acceda a una ruta inválida para saber que no hay contenido disponible en esa ruta. | **Escenario:** Dado que el usuario accede a una ruta inválida cuando el sistema no puede encontrar la ruta entonces el sistema muestra el mensaje de página no encontrada incluyendo la ruta no disponible   <br>  **Escenario:** Dado que el usuario está en la página de “Página no encontrada” cuando el usuario elige ir a la vista de inicio entonces el sistema navega al usuario a la vista de inicio   |           EP01                |

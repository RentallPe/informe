...
<p align="center">
  <img src="./assets/commits.png" alt="Commits por integrante" width="600">
</p>
...
|  Cumba Rengifo Leonardo Raul  |   Ingeniería de Software<br> 5to Ciclo<br>2023-2<br>Universidad Peruana de Ciencias Aplicadas |   ![Leonardo](Imagenes/leonardo.jpg) |  Estudiante de Ingeniería de Software que quiere enfocarse en backend o en DBA. En la actualidad me gustaria especialiarse en DBA |
|   ----------   |     --------  | -------  | ------   |   
|   ---------   |    --------   | --------   |  -----  |
## 1.2 Solution Profile

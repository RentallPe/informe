...
| ----- | ----- | ----- | ----- | ----- |
| Landing Page Informativa y Comercial / **US01** | Visualización de servicios de remodelación | Como visitante, quiero ver los tipos de remodelación para identificar cuál se ajusta a mis necesidades. | **E1:** Al entrar a “Servicios”, lista cada servicio con descripción y precio base. **E2:** Desde “Proyectos/Beneficios IoT”, muestra info clara sobre ahorro/seguridad/sostenibilidad. | **EP03** |
| Landing Page Informativa y Comercial / **US02** | Visualización de sección de proyectos | Como visitante, quiero ver ejemplos de proyectos realizados para confiar en la calidad. | **E1:** En “Proyectos”, al seleccionar uno se ven fotos, descripción, métricas y tiempos. **E2:** Con filtros de categoría/fecha, la lista se actualiza. | **EP03** |
| Landing Page Informativa y Comercial / **US03** | Visualización de beneficios IoT | Como visitante, quiero conocer beneficios IoT para entender el valor agregado. | **E1:** En “Beneficios IoT”, se despliegan casos reales de ahorro, seguridad y sostenibilidad. **E2:** En “Conocer más”, navega a página con métricas y ejemplos. | **EP03** |
| Monitoreo IoT en Remodelaciones / **US04** | Monitoreo de consumo energético | Como usuario, quiero un panel de consumo por propiedad para optimizar recursos. | **E1:** Por rango de fechas, series de consumo por día/mes. **E2:** Sin datos, muestra “sin lecturas” y sugiere otro rango. | **EP02** |
| Monitoreo IoT en Remodelaciones / **US05** | Recibir notificaciones IoT | Como usuario, quiero alertas por falla o consumo excesivo para actuar. | **E1:** Lectura supera umbral → alerta por canal preferido. **E2:** Al “reconocer” alerta, cambia estado y queda en historial. | **EP02** |
| Funcionalidades Avanzadas de Cliente / **US06** | Catálogo de Combos de Propiedades | Como admin, quiero crear/editar **combos** de propiedades/beneficios. | **E1:** Combo válido (nombre, propiedades, precio, vigencia) → guarda versionado (borrador/publicado). **E2:** Al vencer vigencia, cambia a “expirado”. | **EP05** |
| Gestión de Cuentas de Usuario / **US07** | Personalización de perfil | Como usuario, quiero actualizar datos y preferencias. | **E1:** Al guardar, valida y persiste; cambios sensibles requieren verificación. **E2:** Avatar inválido → error claro. | **EP01** |
| Gestión de Cuentas de Usuario / **US08** | Seguridad de datos | Como usuario, quiero datos cifrados y protegidos. | **E1:** Datos sensibles cifrados en tránsito y reposo. **E2:** Acceso no autorizado → registra y notifica. | **EP04** |
| Funcionalidades Avanzadas de Cliente / **US09** | Historial de proyectos | Como cliente, quiero un historial cronológico de mis remodelaciones. | **E1:** Filtro por estado/fecha, lista paginada. **E2:** En detalle, se ven entregables y resultados. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US10** | Dejar opiniones | Como cliente, quiero reseñas del servicio para ayudar a otros. | **E1:** Al finalizar proyecto, puedo publicar reseña (moderación). **E2:** Puedo editar/eliminar mi reseña; queda histórico. | **EP05** |
| Monitoreo IoT en Remodelaciones / **US11** | Alertas de seguridad | Como usuario, quiero alertas por movimiento fuera de horario. | **E1:** Evento fuera de horario → alerta “seguridad”. **E2:** Varias en el día → resumen de incidencias. | **EP02** |
| Funcionalidades Avanzadas de Cliente / **US12** | **Monitoreo de gastos por propiedad** | Como cliente, quiero registrar y ver **gastos** (agua/luz/mantenimiento). | **E1:** POST /expenses válido → guarda y actualiza totales del mes. **E2:** GET /expenses con filtros → lista y agregados por mes/categoría. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US13** | **Presupuesto y alertas de sobre-gasto** | Como cliente, quiero fijar **presupuesto mensual** por propiedad. | **E1:** ≥90% del presupuesto → alerta preventiva. **E2:** \>100% → alerta crítica y estado “excedido”. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US14** | Comparación de presupuestos | Como cliente, quiero comparar cotizaciones por precio/tiempo/calidad. | **E1:** Vista comparativa entre cotizaciones seleccionadas. **E2:** Exportación a PDF/CSV. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US15** | **Calendario de mantenimiento** | Como propietario, quiero programar tareas de mantenimiento con recordatorios. | **E1:** Recordatorios T-7/T-1 antes de la fecha. **E2:** Al marcar “completada”, permite adjuntar evidencias; queda histórico. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US16** | Gestión de pagos | Como cliente, quiero ver pagos realizados y pendientes. | **E1:** Lista filtrable con monto, vencimiento, método. **E2:** Webhook PSP “capturado” → estado “pagado”. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US17** | Recordatorios de pago | Como cliente, quiero recordatorios antes del vencimiento. | **E1:** T-3/T-1 envía notificación por canal preferido. **E2:** Pago confirmado → se desactiva recordatorio. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US18** | Registro de incidencias | Como cliente, quiero reportar incidencias durante la obra. | **E1:** Asignación de responsable y SLA. **E2:** Cierre de sprint → reporte de incidencias. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US19** | **Ingesta de lecturas (medidores)** | Como sistema/usuario IoT, quiero enviar lecturas de consumo. | **E1:** POST /readings firmado → valida, normaliza y guarda. **E2:** Lectura fuera de rango → evento **ReadingOutOfRange**. | **EP02** |
| Funcionalidades Avanzadas de Cliente / **US20** | **Exportar historial de pagos y gastos** | Como cliente, quiero exportar pagos/gastos a CSV/XLSX/PDF. | **E1:** Se encola job y entrega URL segura. **E2:** Enlace expira a los 7 días y se purga. | **EP05** |
| Monitoreo IoT en Remodelaciones / **US21** | Panel de control de dispositivos IoT | Como supervisor, quiero ver estado de dispositivos (online/offline). | **E1:** Lista con estado, última señal y versión. **E2:** En detalle, alertas asociadas. | **EP02** |
| Monitoreo IoT en Remodelaciones / **US22** | Mapa de sensores | Como supervisor, quiero ver ubicación de sensores. | **E1:** Mapa con posiciones en tiempo real. **E2:** Desconexión → se marca “fuera de línea”. | **EP02** |
| Funcionalidades Avanzadas de Cliente / **US23** | Sugerencias de mejoras | Como cliente, quiero sugerencias sostenibles tras la remodelación. | **E1:** Al abrir recomendación, muestra impacto y pasos. **E2:** Al marcar aplicada, se refleja en perfil. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US24** | Calificación del servicio | Como cliente, quiero calificar (1–5) y comentar. | **E1:** Tras finalizar proyecto, permite calificar y comentar. **E2:** Opción de publicar en landing (moderación). | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US25** | Soporte técnico en línea | Como usuario, quiero contactar soporte. | **E1:** Ticket creado/notificado a agente. **E2:** Al cerrar, encuesta de satisfacción. | **EP05** |
| Gestión de Cuentas de Usuario / **US26** | Control de acceso de usuarios | Como admin, quiero gestionar permisos por rol. | **E1:** Cambios de rol aplican al instante. **E2:** Intento no autorizado → 403 y auditoría. | **EP01** |
| Gestión de Cuentas de Usuario / **US27** | Recuperación de contraseña | Como usuario, quiero recuperar mi contraseña. | **E1:** Link enviado permite crear nueva. **E2:** Link expirado se invalida y ofrece reenviar. | **EP01** |
| Funcionalidades Avanzadas de Cliente / **US28** | Configuración de notificaciones | Como usuario, quiero elegir canales (email/push/SMS). | **E1:** Preferencias guardadas se aplican a siguientes eventos. **E2:** Canal desactivado no se usa. | **EP05** |
| Gestión de Cuentas de Usuario / **US29** | Multilenguaje | Como visitante, quiero cambiar idioma de la plataforma. | **E1:** Idioma soportado aplica en toda la UI. **E2:** Idioma no soportado → usa por defecto. | **EP01** |
| Funcionalidades Avanzadas de Cliente / **US30** | Filtrado de proyectos | Como cliente, quiero filtrar por fecha/estado. | **E1:** Lista se actualiza automáticamente. **E2:** Al limpiar filtros, vuelve a lista completa. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US31** | Resumen financiero | Como cliente, quiero ver costos y ahorros para evaluar ROI. | **E1:** KPIs y gráficos por rango/propiedad. **E2:** Exportación a PDF. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US32** | Integración con calendario | Como cliente, quiero sincronizar entregas/reuniones. | **E1:** Conectar Google/Outlook programa hitos. **E2:** Revocar acceso desuscribe eventos. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US33** | Gestión de documentos | Como cliente, quiero subir/guardar documentos (planos/permiso). | **E1:** Guarda con metadatos y versiones. **E2:** Tamaño excedido → error claro. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US34** | Historial de notificaciones | Como usuario, quiero ver alertas/notificaciones pasadas. | **E1:** Filtro por tipo/fecha con paginación. **E2:** Al abrir, marca como leída. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US35** | Reportes personalizados | Como admin, quiero reportes con métricas/filtros personalizados. | **E1:** Al ejecutar, genera reporte. **E2:** Guardar configuración permite reutilizar. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US36** | Vista de progreso en gráfico | Como cliente, quiero ver avance (completadas vs pendientes). | **E1:** Muestra barras/línea por tareas. **E2:** Exporta PDF con estado actual. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US37** | Validación de calidad | Como supervisor, quiero checklist de calidad con evidencias. | **E1:** Completar checklist guarda con adjuntos. **E2:** Hallazgos se agregan al historial. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US38** | **Importación masiva de gastos** | Como cliente, quiero importar gastos por lote. | **E1:** Archivo válido crea registros y reporte de errores. **E2:** Duplicados se omiten con explicación. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US39** | **Pagos pendientes y recordatorios** | Como cliente, quiero ver **pagos pendientes** con montos y vencimientos. | **E1:** GET /payments?status=pending devuelve montos, fechas y enlaces. **E2:** CRON T-3/T-1 envía recordatorios por canal. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US40** | Integración con facturación electrónica | Como cliente, quiero recibir facturas electrónicas. | **E1:** Pago capturado → emisión FE y adjuntos PDF/XML. **E2:** Error de emisión → reintento y notificación. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US41** | Exportación de datos | Como admin, quiero exportar información de proyectos. | **E1:** Selecciono columnas/filtros → archivo generado. **E2:** Dataset grande se procesa por lotes y notifica URL. | **EP05** |
| Gestión de Cuentas de Usuario / **US42** | Roles de usuario | Como admin, quiero asignar roles (cliente/proveedor/supervisor). | **E1:** Al asignar, hereda permisos. **E2:** Cambiar rol actualiza permisos activos. | **EP01** |
| Monitoreo IoT en Remodelaciones / **US43** | API para integración externa | Como empresa, quiero exponer API con datos seleccionados. | **E1:** Token válido → endpoints devuelven JSON acordado. **E2:** Límite de cuota excedido → 429\. | **EP02** |
| Funcionalidades Avanzadas de Cliente / **US44** | Auditoría de cambios | Como admin, quiero historial de cambios. | **E1:** Registra quién/cuándo/qué. **E2:** Filtros y exportación. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US45** | **Servicio de Dashboard (KPIs y widgets)** | Como usuario, quiero ver un **dashboard** con propiedades, alertas, consumo y pagos pendientes. | **E1:** GET /dashboard retorna widgets (top propiedades, últimas 5 alertas, consumo 12M, pagos pendientes). **E2:** Filtros por propiedad/rango recalculan widgets. | **EP05** |
| Monitoreo IoT en Remodelaciones / **US46** | Detección de anomalías con IA | Como cliente, quiero detectar patrones anómalos de energía. | **E1:** Modelo detecta anomalía → alerta “patrón inusual”. **E2:** Varias anomalías → informe consolidado mensual. | **EP02** |
| Funcionalidades Avanzadas de Cliente / **US47** | Panel de métricas de sostenibilidad | Como cliente, quiero ver métricas de ahorro, CO₂ y eficiencia. | **E1:** KPIs y gráficos por rango/propiedad. **E2:** Exportar PDF con cifras actuales. | **EP05** |
| Funcionalidades Avanzadas de Cliente / **US48** | Suscripción a eventos (SSE/WebSocket) | Como usuario avanzado, quiero actualizaciones en tiempo real. | **E1:** Cambios en widgets/alertas → evento push. **E2:** Reconexión hace replay de últimos N eventos. | **EP05** |
| Gestión de Cuentas de Usuario / **US49** | Descarga de comprobantes electrónicos | Como cliente, quiero descargar PDF/XML de mis pagos. | **E1:** Botones de descarga en cada pago con FE. **E2:** Comprobante invalidado muestra estatus y reemisión. | **EP05** |

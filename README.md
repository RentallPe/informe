...
| ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software. | TB1: Arturo Saravia: Ayudé en la relización de la landing page y del documento  TB1: Braulio Torrejon: Apoyo de los mockups y wireframes y prototyping del capitulo 4 TB1 Leonardo Cumba: He desarrollado el cap 2, 4 y 5   TB1 Gabriel Perez: He desarrollado el capitulo 3        | El equipo llevó a cabo una amplia gama de actividades para comunicar de manera efectiva las ideas y resultados del proyecto de ingeniería. Esto incluyó la realización de entrevistas, la elaboración de Statements y Hypothesis Statements como parte del proceso Lean UX, la creación de User Personas y el mapeo de la experiencia del usuario. Además, se realizó un análisis competitivo, se desarrollaron User Stories y se establecieron estrategias frente a competidores. Se utilizaron herramientas visuales como Lean UX Canvas y Style Guidelines, y se llevaron a cabo actividades como Empathy Mapping para comprender las necesidades de los usuarios. Todo esto se complementó con la creación de Landing Page y el diseño de interfaces de usuario para transmitir la propuesta de valor del proyecto de manera efectiva. |
...
| **US11**      | Alertas de seguridad                       | Como usuario, quiero recibir alertas si se detecta movimiento fuera de horario en mi establecimiento, para actuar rápidamente y proteger mis bienes.                                  | **Escenario:** Dado que el sistema IoT detecta movimiento en horario no laboral, cuando esto ocurre, entonces debería enviarme una notificación inmediata en la app y un correo de alerta.                           |
| **US12**      | Seguimiento en tiempo real                 | Como cliente, quiero ver en tiempo real el avance de mi proyecto de remodelación, para tener visibilidad de las etapas completadas y las pendientes.                                  | **Escenario:** Dado que mi proyecto está en ejecución, cuando accedo al panel de seguimiento, entonces debería mostrarme un porcentaje de avance y las tareas completadas.                                           |
| **US13**      | Firma digital de contratos                 | Como cliente, quiero poder firmar contratos digitalmente desde la plataforma, para agilizar el inicio de los trabajos sin trámites físicos.                                           | **Escenario:** Dado que he revisado el contrato, cuando lo firmo digitalmente, entonces debería registrarse con sello de tiempo y guardarse en mi perfil.                                                            |
| **US14**      | Comparación de presupuestos                | Como cliente, quiero comparar presupuestos de diferentes proveedores dentro de la plataforma, para elegir la opción más conveniente.                                                  | **Escenario:** Dado que solicité cotizaciones, cuando visualizo los resultados, entonces debería poder verlos comparados en precio, tiempo estimado y calidad de materiales.                                         |
| **US15**      | Agenda de reuniones                        | Como cliente, quiero poder agendar reuniones virtuales con el equipo de remodelación, para resolver dudas y validar avances.                                                          | **Escenario:** Dado que necesito coordinar una reunión, cuando accedo a la agenda, entonces debería poder seleccionar fecha y hora disponibles para la videollamada.                                                 |
| **US16**      | Gestión de pagos                           | Como cliente, quiero poder ver mis pagos realizados y los pendientes, para llevar un control de mi inversión.                                                                         | **Escenario:** Dado que ya he hecho pagos, cuando ingreso a la sección de pagos, entonces debería ver el detalle de transacciones y fechas de vencimiento de pagos pendientes.                                       |
| **US17**      | Recordatorios de pago                      | Como cliente, quiero recibir recordatorios automáticos de mis pagos próximos, para evitar retrasos en la obra.                                                                        | **Escenario:** Dado que tengo un pago próximo a vencer, cuando falten 3 días para la fecha, entonces debería recibir un correo y una notificación en la app.                                                         |
| **US18**      | Registro de incidencias                    | Como cliente, quiero reportar incidencias durante la remodelación (retrasos, problemas de calidad), para que el equipo pueda solucionarlas rápidamente.                               | **Escenario:** Dado que detecté un problema en la obra, cuando lo reporto desde la app, entonces debería registrarse en el sistema y asignarse a un responsable.                                                     |
| **US19**      | Confirmación de entrega de materiales      | Como proveedor, quiero recibir confirmación cuando el material haya sido entregado en la obra, para asegurarme de que se recibió correctamente.                                       | **Escenario:** Dado que mi pedido llegó, cuando el encargado confirma la recepción, entonces debería enviarme una notificación y guardar un comprobante digital.                                                     |
| **US20**      | Descarga de reportes                       | Como cliente, quiero poder descargar en PDF los reportes de mi remodelación, para archivarlos o presentarlos a otros.                                                                 | **Escenario:** Dado que el proyecto ha generado reportes, cuando descargo el documento, entonces debería generarse un PDF con datos de consumo, seguridad y eficiencia.                                              |
| **US21**      | Panel de control de dispositivos IoT       | Como supervisor, quiero ver un panel con el estado de los dispositivos IoT instalados, para detectar fallas rápidamente.                                                              | **Escenario:** Dado que hay varios sensores instalados, cuando accedo al panel, entonces debería mostrar el estado (activo, inactivo, en falla) de cada uno.                                                         |
| **US22**      | Mapa de sensores                           | Como supervisor, quiero ver en un mapa la ubicación de los sensores instalados, para planificar el mantenimiento de forma eficiente.                                                  | **Escenario:** Dado que el sistema conoce la ubicación de los sensores, cuando accedo a la vista de mapa, entonces debería verlos geolocalizados en tiempo real.                                                     |
| **US23**      | Sugerencias de mejoras                     | Como cliente, quiero recibir sugerencias de mejoras sostenibles después de la remodelación, para optimizar aún más mi local.                                                          | **Escenario:** Dado que finalizó la obra, cuando accedo a la sección de recomendaciones, entonces debería mostrarme opciones como paneles solares, ahorro de agua, etc.                                              |
| **US24**      | Calificación del servicio                  | Como cliente, quiero calificar el servicio de remodelación, para dar retroalimentación al equipo y mejorar la plataforma.                                                             | **Escenario:** Dado que se completó el proyecto, cuando califico con estrellas y comentarios, entonces la información debería guardarse y mostrarse en la sección de reseñas.                                        |
| **US25**      | Soporte técnico en línea                   | Como usuario, quiero poder contactar soporte técnico desde la plataforma, para resolver cualquier problema con el sistema IoT o mi cuenta.                                            | **Escenario:** Dado que necesito ayuda, cuando accedo a la sección de soporte, entonces debería poder iniciar un chat en línea o abrir un ticket de soporte.                                                         |
| **US26**      | Control de acceso de usuarios              | Como administrador, quiero gestionar permisos de usuarios en la plataforma, para controlar quién puede ver o editar información de los proyectos.                                     | **Escenario:** Dado que hay distintos roles en el sistema, cuando asigno permisos, entonces los usuarios solo deberían acceder a las secciones permitidas.                                                           |
| **US27**      | Recuperación de contraseña                 | Como usuario, quiero recuperar mi contraseña en caso de olvido, para no perder acceso a mi cuenta.                                                                                    | **Escenario:** Dado que olvidé mi contraseña, cuando solicito recuperación, entonces debería recibir un enlace seguro en mi correo para restablecerla.                                                               |
| **US28**      | Configuración de notificaciones            | Como usuario, quiero configurar qué tipo de notificaciones deseo recibir (email, push, SMS), para evitar información innecesaria.                                                     | **Escenario:** Dado que entro a mi configuración, cuando selecciono mis preferencias, entonces el sistema debería respetarlas para futuras alertas.                                                                  |
| **US29**      | Multilenguaje                              | Como visitante, quiero cambiar el idioma de la plataforma, para comprender toda la información en mi lengua preferida.                                                                | **Escenario:** Dado que accedo a la plataforma, cuando selecciono otro idioma en el menú, entonces toda la interfaz debería traducirse automáticamente.                                                              |
| **US30**      | Filtrado de proyectos                      | Como cliente, quiero filtrar mis proyectos por fecha o estado, para encontrar fácilmente la información que busco.                                                                    | **Escenario:** Dado que tengo varios proyectos, cuando aplico filtros, entonces debería mostrarse solo la lista que coincide con los criterios.                                                                      |
| **US31**      | Resumen financiero                         | Como cliente, quiero ver un resumen de costos acumulados y ahorros generados, para evaluar el retorno de inversión de la remodelación.                                                | **Escenario:** Dado que el sistema tiene datos de consumo y pagos, cuando accedo al panel financiero, entonces debería mostrar métricas claras y gráficos comparativos.                                              |
| **US32**      | Integración con calendario                 | Como cliente, quiero sincronizar mis fechas de entrega y reuniones con mi calendario personal (Google, Outlook), para organizar mejor mi agenda.                                      | **Escenario:** Dado que agendo una reunión, cuando confirmo la fecha, entonces debería poder exportarse al calendario que elija.                                                                                     |
| **US33**      | Gestión de documentos                      | Como cliente, quiero subir y almacenar documentos relacionados con el proyecto (planos, permisos), para centralizar toda la información.                                              | **Escenario:** Dado que accedo a la sección de documentos, cuando subo un archivo, entonces debería guardarse y quedar disponible para el equipo de trabajo.                                                         |
| **US34**      | Historial de notificaciones                | Como usuario, quiero ver el historial de notificaciones recibidas, para no perder información importante si no estaba conectado.                                                      | **Escenario:** Dado que he recibido alertas, cuando accedo al historial, entonces debería mostrarse una lista con la fecha y descripción de cada notificación.                                                       |
| **US35**      | Reportes personalizados                    | Como administrador, quiero generar reportes personalizados seleccionando métricas específicas, para obtener información más relevante.                                                | **Escenario:** Dado que configuro un reporte, cuando selecciono las métricas y el rango de fechas, entonces debería generarse un informe con esa información.                                                        |
| **US36**      | Vista de progreso en gráfico               | Como cliente, quiero ver el avance de mi proyecto en un gráfico de barras o línea, para interpretar fácilmente el progreso.                                                           | **Escenario:** Dado que tengo tareas registradas, cuando entro a la sección de progreso, entonces debería mostrarse un gráfico visual con el avance.                                                                 |
| **US37**      | Validación de calidad                      | Como supervisor, quiero registrar inspecciones de calidad en cada etapa de la remodelación, para garantizar que se cumplan los estándares.                                            | **Escenario:** Dado que finaliza una etapa, cuando lleno un checklist de calidad, entonces debería registrarse en el sistema y mostrarse en el reporte final.                                                        |
| **US38**      | Carga de fotos de avance                   | Como equipo de obra, quiero subir fotos de cada etapa completada, para mantener al cliente informado visualmente.                                                                     | **Escenario:** Dado que se completó un hito, cuando subo una foto, entonces debería quedar asociada al avance del proyecto y visible para el cliente.                                                                |
| **US39**      | Chat en tiempo real                        | Como cliente, quiero poder comunicarme por chat con el equipo de remodelación, para resolver dudas sin necesidad de llamadas.                                                         | **Escenario:** Dado que tengo una consulta, cuando abro el chat, entonces debería permitirme enviar mensajes y recibir respuestas del equipo.                                                                        |
| **US40**      | Integración con facturación electrónica    | Como cliente, quiero recibir facturas electrónicas de mis pagos, para cumplir con los requisitos legales.                                                                             | **Escenario:** Dado que realizo un pago, cuando se confirma, entonces debería enviarse automáticamente la factura a mi correo.                                                                                       |
| **US41**      | Exportación de datos                       | Como administrador, quiero exportar la información de proyectos en formatos CSV o Excel, para analizar datos fuera de la plataforma.                                                  | **Escenario:** Dado que estoy en el panel de proyectos, cuando selecciono exportar, entonces debería generarse un archivo con la información filtrada.                                                               |
| **US42**      | Roles de usuario                           | Como administrador, quiero asignar roles como cliente, proveedor, técnico, supervisor, para organizar los accesos de manera correcta.                                                 | **Escenario:** Dado que agrego un nuevo usuario, cuando le asigno un rol, entonces debería aplicarse en sus permisos dentro del sistema.                                                                             |
| **US43**      | API para integración externa               | Como empresa, quiero tener acceso a una API de datos de proyectos, para integrar la información con otros sistemas corporativos.                                                      | **Escenario:** Dado que tengo credenciales de API, cuando hago una solicitud, entonces debería devolver datos en formato JSON de manera segura.                                                                      |
| **US44**      | Auditoría de cambios                       | Como administrador, quiero ver un historial de cambios realizados en el proyecto, para mantener trazabilidad de modificaciones.                                                       | **Escenario:** Dado que se actualiza una tarea o presupuesto, cuando reviso el historial, entonces debería mostrar qué usuario hizo el cambio y cuándo.                                                              |
| **US45**      | Reconocimiento de voz                      | Como cliente, quiero usar comandos de voz para consultar el avance del proyecto, para facilitar el uso desde el móvil.                                                                | **Escenario:** Dado que tengo un dispositivo compatible, cuando activo el modo de voz, entonces debería responder con la información solicitada.                                                                     |
| **US46**      | Detección de anomalías con IA              | Como cliente, quiero que el sistema detecte patrones anormales en el consumo de energía, para anticipar fallas.                                                                       | **Escenario:** Dado que el sistema analiza datos, cuando encuentra un patrón fuera de lo normal, entonces debería generar una alerta con recomendaciones.                                                            |
| **US47**      | Panel de métricas de sostenibilidad        | Como cliente, quiero ver métricas sobre ahorro de energía, reducción de CO₂ y eficiencia, para medir el impacto positivo de la remodelación.                                          | **Escenario:** Dado que se recopilan datos, cuando entro al panel de sostenibilidad, entonces debería mostrar gráficos con esos indicadores.                                                                         |
| **US48**      | Reservar inspecciones                      | Como cliente, quiero reservar inspecciones presenciales del equipo técnico, para validar el avance físico de la obra.                                                                 | **Escenario:** Dado que solicito una inspección, cuando selecciono una fecha, entonces debería agendarse y notificar al equipo de campo.                                                                             |
